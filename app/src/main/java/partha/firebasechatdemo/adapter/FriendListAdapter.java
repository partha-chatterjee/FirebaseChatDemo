...
import partha.firebasechatdemo.ChatActivity;
...
public class FriendListAdapter extends RecyclerView.Adapter<FriendListAdapter.ViewHolder> {
    ...
    public FriendListAdapter(Context con, ArrayList<User> userList, User currentUser){
        this.mContext = con;
    ...
    public FriendListAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        FriendListAdapter.ViewHolder vh = new FriendListAdapter.ViewHolder(itemView);
        return vh;
    }
