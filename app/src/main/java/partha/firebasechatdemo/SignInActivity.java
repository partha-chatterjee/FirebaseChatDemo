...
public class SignInActivity extends AppCompatActivity implements GoogleApiClient.OnConnectionFailedListener,
    ...
    public void onStart() {
        ...
        if (mFirebaseAuth.getCurrentUser() != null) {
            writeNewUser(mFirebaseAuth.getCurrentUser());
        }
    }
    ...
    private void writeNewUser(FirebaseUser mUser) {
        User user = new User(mUser.getDisplayName(),
                                    mUser.getPhotoUrl().toString(),
                                        mUser.getEmail(),
                                            mUser.getUid(), mUser.getProviderId());

        mDatabase.child("users").child(mUser.getUid()).setValue(user);
        /*ArrayList<String> userNames = new ArrayList<>();
        userNames.add(mUser.getUid());
        mDatabase.child("usernamelist").setValue(userNames);*/

        // Go to list
//        startActivity(new Intent(SignInActivity.this, RecentMessageActivity.class));
